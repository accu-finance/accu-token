...
abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDelegationToken {
   ...
   * In this initial implementation with no ACCU minting, simply returns the current supply
   * A snapshots mapping will need to be added in case a mint function is added to the ACCU token in the future
   **/
   ...
   * the ACCU token and StakeToken already include a mapping for the snapshots, so we require contracts
